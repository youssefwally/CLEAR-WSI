...
parser.add_argument('--top_n', nargs='+', default=[1, 3, 5], help='Number of top patches to select')
...
for _top_n in top_n:
    ...
    y_true, y_pred, sorted_labels, sorted_distances, metrics = leave_one_out_test(
